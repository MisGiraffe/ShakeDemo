...
@interface WBShakeOneViewController ()
...
@implementation WBShakeOneViewController
...
- (void)viewDidLoad
{
    ...
    [self.successBtn setTitle:@"1519" forState:UIControlStateNormal];
...
//    self.successBtn.layer.borderColor = [UIColor clearColor].CGColor;
//    self.successBtn.layer.cornerRadius = 40;
//    [self.successBtn setTitle:@"long1519" forState:UIControlStateNormal];
//    [self.successBtn setTitleColor:COLOR(50, 50, 50, 1) forState:UIControlStateNormal];
//    [self.successBtn addTarget:self action:@selector(longSuccessBtnClicked) forControlEvents:UIControlEventTouchUpInside];
    ...
    self.lightBtn.frame = CGRectMake(WIDTH/2-150, 80 + 80 + 40 + 64, 80, 80);
    ...
    self.mediumBtn.frame = CGRectMake(WIDTH/2-40, 80 + 80 + 40 + 64, 80, 80);
...
{
    [ZZRHapticFeedbackManager wbAudioServicesPlaySystemSound1519];
}
